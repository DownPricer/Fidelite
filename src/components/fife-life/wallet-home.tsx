        ...
        <div className="wallet-page-body flex min-h-0 flex-1 flex-col">
          <header className="wallet-page-header relative z-50 grid shrink-0 grid-cols-[1fr_auto_1fr] items-center">
            ...
            <div className="brand-pill-glassy pointer-events-none flex flex-col items-center gap-1 px-3 py-2 justify-self-center">
              ...
              <div className="text-center leading-tight">
                <p className="text-[10px] font-semibold uppercase tracking-[0.22em] text-[var(--ink-soft)]">Fideto</p>
          ...
          <div className="wallet-hero-column">
            <section className="wallet-points-block shrink-0 px-1">
              <p className="text-[11px] font-bold uppercase tracking-[0.24em] text-[var(--muted-strong)]">Points Fideto</p>
            ...
            <div className="wallet-deck-block shrink-0">
              ...
              <section className="wallet-primary-actions" aria-label="Actions QR et Google Wallet">
                <WalletQrAction
                  ...
                  clientNumber={clientNumber}
                  merchantName={activeMerchantCard?.name ?? "Fideto"}
                />
          ...
          <section className="wallet-reward-block glass-panel shrink-0 p-4 lg:hidden">
            ...
            {activeNextReward ? (
              ...
              <p className="text-xs text-[var(--muted-strong)]">
                Aucun prochain avantage Fideto pour le moment.
              </p>
            ) : (
              <p className="text-xs text-[var(--muted-strong)]">
                {activeMerchantCard
